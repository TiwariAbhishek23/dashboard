            ...
            {!isCollapsed && (
                <div className="w-60 h-full border-r border-gray-300 rounded-r-xl p-4 flex flex-col shadow-lg transition-all duration-300">
                    ...
                    <div className="flex justify-between items-center border-b border-gray-700 pb-3 mb-4">
                        {isSearching ? (
                            <div className="flex items-center w-full space-x-2 p-2 border border-gray-700 rounded-2xl">
                            ...
                            <>
                                <Filter size={15} className="cursor-pointer" onClick={toggleSort} />
                                {sortOpen && (
                                    <div className="absolute w-40 border border-gray-700 rounded shadow-lg z-10">
                                        <button className="w-full p-2 hover:bg-gray-200" onClick={() => sortFolders("name")}>Sort by Name</button>
                                        <button className="w-full p-2 hover:bg-gray-200" onClick={() => sortFolders("size")}>Sort by Size</button>
                                    </div>
                                )}
