...
import { getBubbleText } from './bubble';
...
function BubbleMenuText(props: BubbleMenuTextProps) {
  ...
  return (
    ...
    >
      {items?.length
        ? (
          <div className="pointer-events-auto w-auto select-none rounded-md !border border-slate-100 bg-background px-3 py-2 shadow-sm transition-all dark:border-neutral-800">
